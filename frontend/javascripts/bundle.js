...
var _nav_bar = __webpack_require__(/*! ./navbar/nav_bar */ "./frontend/components/navbar/nav_bar.jsx");

var _nav_bar2 = _interopRequireDefault(_nav_bar);

var _main_form = __webpack_require__(/*! ./main/main_form */ "./frontend/components/main/main_form.jsx");
...
/***/ "./frontend/components/main/delivery_box.jsx":
/*!***************************************************!*\
  !*** ./frontend/components/main/delivery_box.jsx ***!
  \***************************************************/
/*! no static exports found */
...
var DeliveryBox = function DeliveryBox(_ref) {
  var stores = _ref.stores;

  if (stores.length === 0) {
    return null;
  } else {
    var StoreItems = stores.map(function (store) {
      var available = store.openYet ? _react2.default.createElement(
        "div",
        { className: "db-avail" },
        "Now Available"
      ) : _react2.default.createElement(
        "div",
        { className: "db-avail" },
        "Coming " + (store.month + 1) + "/" + (store.day + 1)
      );
      return _react2.default.createElement(
        "div",
        { key: store.id },
...
/***/ "./frontend/components/main/main_form.jsx":
/*!************************************************!*\
  !*** ./frontend/components/main/main_form.jsx ***!
  \************************************************/
/*! no static exports found */
...
var _delivery_box = __webpack_require__(/*! ./delivery_box */ "./frontend/components/main/delivery_box.jsx");

var _delivery_box2 = _interopRequireDefault(_delivery_box);
...
var MainForm = function (_React$Component) {
  ...
  function MainForm(props) {
    ...
    _this.parseResponse = _this.parseResponse.bind(_this);
    return _this;
  }
  ...
  _createClass(MainForm, [{
    ...
    value: function handleSubmit(e) {
      ...
      fetch('https://shipt-zip-code-test-api.herokuapp.com/api/zip_codes/' + this.state.zipcode).then(function (response) {
        ...
        if (json.error) {
          ...
          var parseStores = _this3.parseResponse(json);
          return _this3.setState({
            stores: parseStores
          });
        }
    ...
    value: function parseResponse(res) {
      var sortedStores = res.stores.sort(function (a, b) {
        return a.name > b.name ? 1 : -1;
      });
      console.log(sortedStores);
      var parseStores = [];
      sortedStores.forEach(function (store) {
        var date = new Date(store.launch_date);
        var year = date.getFullYear();
        var month = date.getMonth();
        var day = date.getDate();
        var today = new Date();
        var openYet = date <= today;
        var parseStore = {
          name: store.name,
          id: store.id,
          year: year,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              null,
              '*Membership offer valid for new members only. Target order of $100 or more must be placed to qualify for $15 credit, which expires 30 days after qualifying order is placed and can be applied to any order from Shipt.'
            )
          )
        ),
        _react2.default.createElement(_delivery_box2.default, { stores: this.state.stores })
      );
    }
  }]);
